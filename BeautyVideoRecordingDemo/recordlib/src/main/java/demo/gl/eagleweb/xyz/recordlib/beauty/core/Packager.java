package demo.gl.eagleweb.xyz.recordlib.beauty.core;
...
public class Packager {
    public static class H264Packager {
    	...
    	public static byte[] H264Header;
    	
    	public static byte[] getSpsPps(MediaFormat mediaFormat) {
            ...
            PPS = PPSByteBuff;
                ...
                SPSByteBuff.get(header, 0, spslength);
                PPSByteBuff.get(header, 0 + spslength, ppslength);
                H264Header = header;
                
                return header;
    	}
    	
    	public static byte[] generateH264Package(ByteBuffer frameData) {
    		...
    		if(H264Header != null) {
    			...
    			System.arraycopy(frameDataByte, 0, outData, H264Header.length,
    					frameDataByte.length);
    			return outData;
    		}
