package demo.gl.eagleweb.xyz.recordlib.beauty.filter;
...
import demo.gl.eagleweb.xyz.recordlib.beauty.core.EglCore;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaAudioEncoder;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaEncoder;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaMuxerWrapper;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaRecordMuxerWrapper;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaType;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.MediaVideoEncoder;
import demo.gl.eagleweb.xyz.recordlib.beauty.core.WindowSurface;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.MagicFilterFactory;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.MagicFilterParam;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.MagicFilterType;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.OpenGLUtils;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.Rotation;
import demo.gl.eagleweb.xyz.recordlib.beauty.utils.TextureRotationUtil;
import demo.gl.eagleweb.xyz.recordlib.camera.CameraInterface;
...
public class MagicCameraDisplay implements Renderer {
    ...
    public void onResume(Activity activity) {
        if (CameraInterface.getInstance().getCamera() == null)
            CameraInterface.getInstance().openCamera(mMediaType, activity);
        if (CameraInterface.getInstance().getCamera() != null) {
...
//     public static final int OUTPLAY_ENCODE_WIDTH = 1280;
//     public static final int OUTPLAY_ENCODE_HEIGHT = 720;
    ...
    private static String getOutputRecordPath() {
